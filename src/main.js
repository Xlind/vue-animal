...
const adminLoginVue = r => require.ensure([], () => r(require('./components/admin/adminLogin.vue')), 'adminLogin'); //后台登录
const admin = r => require.ensure([], () => r(require('./components/admin/admin.vue')), 'admin'); //后台
