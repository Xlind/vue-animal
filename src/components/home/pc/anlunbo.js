...
carousels.each(function() {
  ...
  if ($obj.data('shift') === 1) {
    ...
    var rule_base = '.carousel.' + id + ' .carousel-inner > .item',
        ...
        rules[1] = rule_base + '.active.left {left: -' + (100 / visibleCnt) + '%; transform: none;}';
        rules[2] = rule_base + '.active.right {left: ' + (100 / visibleCnt) + '%; transform: none;}';
        rules[3] = rule_base + '.prev {left: -' + (100 / visibleCnt) + '%; transform: none;}';
